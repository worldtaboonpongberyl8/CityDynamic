...
export default class SupplementaryGenerator extends LightningElement {
    currentRecordId;
	templateMappingType = 'Supplementary Agreement';
	isGenerateSupplementary = false;
	languages = [];
	...
	onGenerate(event) {
		this.isGenerateSupplementary = true;
	}
